...
namespace cth::vk {
Renderer::Renderer(Core const& core, RenderPulse const& pulse, Config config) : _core{&core}, _pulse{&pulse} {
...
Renderer::Renderer(Core const& core, RenderPulse const& pulse, Config const& config, create_t) : Renderer{core, pulse, config} { create(); }
...
void Renderer::linkStageDependencies(Config::stage_map_t& stages, Config::dependencies_t const& dag, id_t source_id, 
