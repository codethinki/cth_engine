...
auto PhysicalDevice::AutoPick(Instance const& instance, Surface const& temp_surface, std::span<Queue const> queues,
    ...
    for(auto& device : devices) {
        auto physicalDevice = Create(instance, temp_surface, queues, requiredExtensions, requiredFeatures, device);
