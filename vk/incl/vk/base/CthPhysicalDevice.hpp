#pragma once
#include "vk/base/queue/CthQueueFamily.hpp"
#include "vk/utility/cth_vk_types.hpp"
#include "vk/utility/device/PhysicalDeviceFeatures.hpp"
...
public:
     ...
     */
    [[nodiscard]] static std::unique_ptr<PhysicalDevice> AutoPick(Instance const& instance, Surface const& temp_surface,
