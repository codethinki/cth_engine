...
public:
     ...
     * @details
     * calls: @ref create(not_null<VkSurfaceKHR>, Config const&)
     */
     ...
     * - @ref PhysicalDevice::AutoPick(Instance const&, not_null<VkSurfaceKHR>, std::span<Queue const>, std::span<std::string const>, utils::PhysicalDeviceFeatures const&)
