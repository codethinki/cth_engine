...
public:
     ...
     */
    explicit DebugMessenger(Config const& config, cth::vk::not_null<VkInstance> instance) : DebugMessenger{config} { create(instance); }
     ...
     */
    void create(cth::vk::not_null<VkInstance> instance);
