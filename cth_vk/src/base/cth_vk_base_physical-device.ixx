...
export module cth.vk.base.physical_device;
...
public:
    ...
    explicit PhysicalDevice(Instance const& instance, utils::PhysicalDeviceFeatures const& required_features,
        std::span<std::string const> required_extensions, vk::not_null<VkSurfaceKHR> surface, vk::not_null<VkPhysicalDevice> vk_device);
     ...
     */
    static std::optional<PhysicalDevice> Create(Instance const& instance, vk::not_null<VkSurfaceKHR> surface, std::span<QueueFamilyProperties const> queues,
     ...
     */
    void create(vk::not_null<VkSurfaceKHR> surface, not_null<VkPhysicalDevice> vk_device);
     ...
     */
    [[nodiscard]] static std::unique_ptr<PhysicalDevice> AutoPick(Instance const& instance, std::span<QueueFamilyProperties const> queues,
        std::span<std::string const> required_extensions, utils::PhysicalDeviceFeatures const& required_features);
     ...
     */
    [[nodiscard]] std::vector<uint32_t> queueFamilyIndices(std::span<QueueFamilyProperties const> queues) const;



    [[nodiscard]] bool supportsQueueSet(std::span<QueueFamilyProperties const> family_properties) const;
   ...
   */
    ...
    [[nodiscard]] static std::vector<QueueFamily> getQueueFamilies(vk::not_null<VkSurfaceKHR> surface, vk::not_null<VkPhysicalDevice> vk_device);
