...
export module cth.vk.base.core;
...
struct Core::Config {
    ...
    std::span<QueueFamilyProperties> queues;
    ...
    static Config Default(std::string_view app_name, std::string_view engine_name, std::span<QueueFamilyProperties> queues,
