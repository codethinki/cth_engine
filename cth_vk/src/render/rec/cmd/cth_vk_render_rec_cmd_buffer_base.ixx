...
export module cth.vk.render.rec.cmd.buffer.base;
...
public:
    ...
    static void destroy(DeviceTable table, not_null<VkCommandPool> vk_pool, VkCommandBuffer buffer);
...
void CmdBuffer::debug_check_handle([[maybe_unused]] vk::not_null<VkCommandBuffer> handle) {}

}

#include "inl/cth_vk_render_rec_cmd_buffer_base.inl"
