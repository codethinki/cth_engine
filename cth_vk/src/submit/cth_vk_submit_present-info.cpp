...
module cth.vk.submit.present_info;

import cth.io.log;

namespace cth::vk {
PresentInfo::PresentInfo(vk::not_null<VkSwapchainKHR> vk_swapchain, std::span<Semaphore const*> wait_semaphores) : _vkSwapchain{vk_swapchain} {
