...
namespace cth {
class Device;
//TEMP left off here, continue refactoring
class HlcDescriptorSetLayout {
public:
    class Builder {
    public:
        explicit Builder(Device& hlc_device) : hlcDevice{hlc_device} {}
...
public:
    ...
    HlcDescriptorPool(Device& hlc_device, uint32_t max_sets, VkDescriptorPoolCreateFlags pool_flags,
