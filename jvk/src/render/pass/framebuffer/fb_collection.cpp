#include "jvk/render/pass/framebuffer/fb_collection.hpp"
...
FramebufferCollection::FramebufferCollection(Core const& core, RenderPass const& render_pass,
...
FramebufferCollection::FramebufferCollection(Core const& core, RenderPass const& render_pass,
    Config const& config,
    VkExtent2D framebuffer_extent) : FramebufferCollection{core, render_pass, config} {
    FramebufferCollection::create(framebuffer_extent);
}
