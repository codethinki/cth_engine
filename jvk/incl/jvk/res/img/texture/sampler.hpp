...
public:
    ...
    static void debug_check_handle(jvk::vk_not_null<VkSampler> sampler);
};
}
...
struct Sampler::State {
    jvk::vk_not_null<VkSampler> vkSampler;
};
...
inline void Sampler::debug_check_handle(jvk::vk_not_null<VkSampler> sampler) {}
