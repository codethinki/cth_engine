...
public:
    ...
    * @throws jvk::result_exception data: VkResult of vkCreateDescriptorPool()
    */
     ...
     * @throws jvk::result_exception data: VkResult of vkResetDescriptorPool()
     */
    void reset();
...
private:
    struct SetLayoutEntry {
        ...
        [[nodiscard]] VkDescriptorSet newVkSet() {
            CTH_ERR(used >= span.size(), "out of descriptor sets")
    ...
    /**
     * @throws jvk::result_exception data: VkResult of vkAllocateDescriptorSets()
     */
    void allocSets();
...
public:
    ...
    struct Builder {
        ...
        explicit Builder(
            std::unordered_map<DescriptorSetLayout const*, uint32_t> const& max_descriptor_sets) {
            addLayouts(max_descriptor_sets);
        }
