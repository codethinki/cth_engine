...
#include "jvk/memory/buffer/CthDefaultBuffer.hpp"

namespace jvk {
class BufferDescriptor : public Descriptor {
public:
    explicit BufferDescriptor(VkDescriptorType type, DefaultBuffer const* buffer,
        size_t const descriptor_size = Constants::WHOLE_SIZE,
        size_t const buffer_offset = 0) : Descriptor(type),
...
public:
    ...
    explicit UniformBufferDescriptor(DefaultBuffer const* buffer,
        size_t const descriptor_size = Constants::WHOLE_SIZE,
        size_t const descriptor_offset = 0) : BufferDescriptor(TYPE, buffer, descriptor_size,
        descriptor_offset) {}
};
