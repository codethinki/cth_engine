...
public:
     ...
     */
    Surface(Instance const& instance, DestructionQueue* destruction_queue, Config config = {}) : _instance
        {&instance}, _destructionQueue{destruction_queue}, _config{std::move(config)} {}
     ...
     */
    static Surface Temp(Instance const& instance, jvk::vk_not_null<VkSurfaceKHR> temp_surface,
        DestructionQueue* destruction_queue = nullptr);


    /**
     * @brief destroys the @ref VkSurfaceKHR
     */
    static void destroy(jvk::vk_not_null<VkInstance> instance, VkSurfaceKHR surface);
...
struct Surface::State {
    jvk::vk_not_null<VkSurfaceKHR> vkSurface;
};
...
inline void Surface::debug_check_handle([[maybe_unused]] jvk::vk_not_null<VkSurfaceKHR> surface) {}
}