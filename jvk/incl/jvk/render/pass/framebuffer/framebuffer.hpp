...
public:
     ...
     * @note calls @ref destroy(jvk::vk_not_null<VkDevice>, VkFramebuffer)
     */
    void destroy();
    /**
...
private:
    ...
    move_ptr<VkFramebuffer_T> _handle = VK_NULL_HANDLE;
    VkExtent2D _extent{};
...
public:
    ...
    static void debug_check_handle(jvk::vk_not_null<VkFramebuffer> vk_framebuffer);
...
struct Framebuffer::State {
    jvk::vk_not_null<VkFramebuffer> vkFramebuffer;
    VkExtent2D extent;
};
}
...
inline void
Framebuffer::debug_check_handle([[maybe_unused]] jvk::vk_not_null<VkFramebuffer> vk_framebuffer) {}
